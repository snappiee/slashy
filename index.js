...
axios.get("https://raw.githubusercontent.com/TahaGorme/slashy/main/index.js").then(function(response) {
  ...
  if (v) {
    ...
    if (v !== version) {
      ...
      hook.send(new MessageBuilder().setTitle("New Version").setURL("https://github.com/TahaGorme/Slashy").setDescription("Current version:** " + version + "**\nNew version: **" + v + "**\nPlease update: " + "https://github.com/TahaGorme/slashy").setColor("#E74C3C"));
    }
  }
...
async function doEverything(token, Client, client1, channelId) {
  ...
  async function main(channel) {
    ...
    // INFO: Deposit money
    if (config.autoDeposit && randomInteger(0, 50) === 19) {
